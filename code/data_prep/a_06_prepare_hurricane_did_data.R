...
library(tidyverse)
library(knitr)
exposure.data <- readRDS('~/Git/tropical_cyclones_educational_attainment_2022/data/tc_exposure/github_processed/tc_annual_county_exposure_treatment_2008_2019.rds')
