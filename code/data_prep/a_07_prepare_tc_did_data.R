...
library(tidyverse)
library(knitr)
cyclone.data <- readRDS('~/Git/tropical_cyclones_educational_attainment_2022/data/tc_exposure/github_processed/tc_annual_county_exposure_treatment_2008_2019.rds')
...
saveRDS(math.DID, paste0(prepared.math.DID.folder, "math_DID_cyclones.rds"))
saveRDS(rla.DID, paste0(prepared.rla.DID.folder, "rla_DID_cyclones.rds"))
