---
title: "Hurricane DID math national model process posterior probabilities"
...
```{r}
math.model.national = readRDS((paste0(full.model.output.folder, "math_model_national.rds")))
```

# Make draws of model parameters
```{r}
draws.model = inla.posterior.sample(num_draws, math.model.national, seed=1234)
```
...
#Save results
```{r}
readr::write_csv(draws.terms.of.interest.summary,paste0(model.output.folder,'math_probabilities_national.csv'))
```
