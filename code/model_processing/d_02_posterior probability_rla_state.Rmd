---
title: "Hurricane DID RLA state model process posterior probabilities"
...
```{r}
rla.model.state = readRDS((paste0(full.model.output.folder, "rla_model_state.rds")))
```
...
# Save results
```{r}
readr::write_csv(draws.terms.of.interest.summary,paste0(model.output.folder,'rla_probabilities_state.csv'))
```
