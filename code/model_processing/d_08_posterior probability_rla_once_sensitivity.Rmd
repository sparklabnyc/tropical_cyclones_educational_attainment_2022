---
title: "Hurricane DID RLA state model process posterior probabilities - exposure only sensitivity model, single hurricane"
...
```{r}
rla.model.state = readRDS((paste0(full.model.output.folder, "rla_model_state_once.rds")))
```
