---
title: "Hurricane DID RLA national model process posterior probabilities"
...
```{r}
rla.model.national = readRDS((paste0(full.model.output.folder, "rla_model_national.rds")))
```
...
# Save results
```{r}
readr::write_csv(draws.terms.of.interest.summary,paste0(model.output.folder,'rla_probabilities_national.csv'))
```
