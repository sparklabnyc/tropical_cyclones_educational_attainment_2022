---
title: "Hurricane DID math model national process posterior probabilities"
...
#Save results
```{r}
readr::write_csv(draws.terms.of.interest.summary,paste0(model.output.folder,'math_probabilities.csv'))
```
