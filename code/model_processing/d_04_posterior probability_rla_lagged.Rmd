...
```{r}
rla.model.state = readRDS((paste0(full.model.output.folder, "rla_model_state_lagged.rds")))
```
...
# Save results
```{r}
readr::write_csv(draws.terms.of.interest.summary,paste0(model.output.folder,'rla_probabilities_state_lagged.csv'))
```
