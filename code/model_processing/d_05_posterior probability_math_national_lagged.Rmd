---
title: "Lagged Hurricane DID math national model process posterior probabilities"
...
```{r}
math.model.national = readRDS((paste0(full.model.output.folder, "math_model_national_lagged.rds")))
```
...
#Save results
```{r}
readr::write_csv(draws.terms.of.interest.summary,paste0(model.output.folder,'math_probabilities_national_lagged.csv'))
```
