---
title: "Hurricane DID math state model process posterior probabilities"
...
```{r}
math.model.state = readRDS((paste0(full.model.output.folder, "math_model_state.rds")))
```
...
#Save results
```{r}
readr::write_csv(draws.terms.of.interest.summary,paste0(model.output.folder,'math_probabilities_state.csv'))
```
