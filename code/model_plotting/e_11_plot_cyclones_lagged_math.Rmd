...
```{r}
results <- read_csv("~/Git/tropical_cyclones_educational_attainment_2022/output/model_output/cyclones_did_lagged_national.csv")
```
...
#Save forest plot
```{r}
pdf(paste0(plot.output.folder,'cyclones_lagged_math_states','.pdf'))
print(fp)
dev.off()
```
