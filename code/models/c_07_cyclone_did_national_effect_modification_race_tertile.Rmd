---
title: "Cyclone DID model national with effect modification; race tertile"
...
```{r,message=FALSE}
readr::write_csv(cyclone.bayes,paste0(model.output.folder,'cyclone_did_national_race_tertile_interaction.csv'))
```
