...
fml.bayes.fixed.interaction.state = gcs_mn_all ~  
                f(state,et*minority_tert,model='iid', hyper=lg_prior) +
                f(cohort,model="iid", hyper = lg_prior) +
                f(year,model="iid", hyper = lg_prior) +
                perfl + perrl + perell + 
                urban + 
...
hurricane.math.bayes.state = data.frame(type='bayes',subject='math', #This chunk of code is not running
...
hurricane.rla.bayes.state = data.frame(type='bayes',subject='rla', #This chunk of code is not running 
