---
title: "Hurricane DID model national with effect modification; race"
...
fml.bayes.fixed.interaction = gcs_mn_all ~  # fml.bayes.fixed.interaction.state
                et*minority_tert + # f(state,et*minority_tert,model='iid', hyper=lg_prior) +
