---
title: "Hurricane lagged DID model national"
...
fml.bayes.overall = gcs_mn_all ~ 
                ...
                pernam + perasn + perblk + perhsp + perecd + 
                perfl + perell + perspeced + baplusall + povertyall + 
                single_momall + urban
...
```{r}
saveRDS(mod.math.bayes.state, paste0(full.model.output.folder, "math_model_state_lagged.rds"))
saveRDS(mod.math.bayes.overall, paste0(full.model.output.folder, "math_model_national_lagged.rds"))
```
...
```{r}
saveRDS(mod.rla.bayes.state, paste0(full.model.output.folder, "rla_model_state_lagged.rds"))
saveRDS(mod.rla.bayes.overall, paste0(full.model.output.folder, "rla_model_national_lagged.rds"))
```
```
...
```{r,message=FALSE}
readr::write_csv(hurricane.bayes,paste0(model.output.folder,'hurricane_did_lagged_national.csv'))
```
