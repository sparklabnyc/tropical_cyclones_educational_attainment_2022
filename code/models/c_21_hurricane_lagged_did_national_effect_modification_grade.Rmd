...
hurricane.math.bayes.fixed.interaction = data.frame(type='bayes',subject='math',
                                 grade=c(3,4,5,6,7,8),
                                 est=mod.math.bayes.fixed.interaction$summary.fixed[c(3:8), ]$mean,
                                 ll=mod.math.bayes.fixed.interaction$summary.fixed[c(3:8), ]$`0.025quant`,
                                 ul=mod.math.bayes.fixed.interaction$summary.fixed[c(3:8), ]$`0.975quant`)
...
hurricane.rla.bayes.fixed.interaction = data.frame(type='bayes',subject='rla',
                                grade=c(3,4,5,6,7,8),
                                 est=mod.rla.bayes.fixed.interaction$summary.fixed[c(3:8), ]$mean,
                                 ll=mod.rla.bayes.fixed.interaction$summary.fixed[c(3:8), ]$`0.025quant`,
                                 ul=mod.rla.bayes.fixed.interaction$summary.fixed[c(3:8), ]$`0.975quant`)
