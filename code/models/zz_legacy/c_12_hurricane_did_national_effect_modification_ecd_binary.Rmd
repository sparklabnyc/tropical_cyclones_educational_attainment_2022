---
title: "Hurricane DID model national with effect modification; economic disadvantage binary"
...
fml.bayes.fixed.interaction = gcs_mn_all ~  
                ...
                povertyall + lninc50all + baplusall + snapall + single_momall
...
```{r,message=FALSE}
readr::write_csv(hurricane.bayes,paste0(model.output.folder,'hurricane_did_national_ecd_binary_interaction.csv'))
```