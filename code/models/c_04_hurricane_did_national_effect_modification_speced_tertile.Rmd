---
title: "Hurricane DID model national with effect modification; special education tertiles"
...
```{r,message=FALSE}
readr::write_csv(hurricane.bayes,paste0(model.output.folder,'hurricane_did_national_specialed_tertile_interaction.csv'))
```
