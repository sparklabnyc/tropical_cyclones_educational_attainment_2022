---
title: "Cyclone DID model national with effect modification; special education tertiles"
...
```{r,message=FALSE}
readr::write_csv(cyclone.bayes,paste0(model.output.folder,'cyclone_did_national_specialed_tertile_interaction.csv'))
```
