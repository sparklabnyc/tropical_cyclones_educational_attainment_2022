---
title: "Sensitivity model for hurricane lagged DID model - sensitivity"
...
## Define Bayesian formula, exposure only
...
```{r}
saveRDS(mod.math.bayes.state, paste0(full.model.output.folder, "math_model_state_lagged_sensitivity.rds"))
saveRDS(mod.math.bayes.overall, paste0(full.model.output.folder, "math_model_national_lagged_sensitivity.rds"))
```
...
```{r}
saveRDS(mod.rla.bayes.state, paste0(full.model.output.folder, "rla_model_state_lagged_sensitivity.rds"))
saveRDS(mod.rla.bayes.overall, paste0(full.model.output.folder, "rla_model_national_lagged_sensitivity.rds"))
```
