---
title: "Hurricane DID model national with effect modification; economic disadvantage tertile"
...
```{r,message=FALSE}
readr::write_csv(hurricane.bayes,paste0(model.output.folder,'hurricane_did_national_ecd_tertile_interaction.csv'))
```