---
title: "Hurricane truncated DID model national with effect modification; race tertile"
...
```{r,message=FALSE}
readr::write_csv(hurricane.bayes,paste0(model.output.folder,'hurricane_truncated_did_national_race_tertile_interaction.csv'))
```
