---
title: "Hurricane DID model national; sensitivity analysis - effect modification of special education tertiles and SES tertiles"
...
```{r,message=FALSE}
readr::write_csv(hurricane.bayes,paste0(model.output.folder,'hurricane_did_national_SES_specialed_interaction.csv'))
```
