---
title: "Cyclone DID model national with effect modification; SES composite tertiles"
...
```{r,message=FALSE}
readr::write_csv(cyclone.bayes,paste0(model.output.folder,'cyclone_did_national_ses_tertile_interaction.csv'))
```
